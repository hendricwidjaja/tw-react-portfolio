...
const TechStack = () => {
  return (
    <div className="flex flex-col md:flex-row md:gap-10 justify-center gap-6">
      <div id="techstackheading" className="flex-col text-center items-center">
        ...
        <div className="flex gap-2 justify-center font-bold text-md mt-2">
          <h3>Some of the</h3>
          <span>
            <FaScrewdriverWrench />
          </span>
      ...
      <section id="tech-stack-grid" className="md:pt-16 px-8 md:max-w-fit">
        <div
          id="tech-stack-icons"
